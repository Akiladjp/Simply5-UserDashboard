...
export default function Card_InAddcart({
	itemID = 0,
	buttonTitle = "",
	quantity = 0,
	name = "",
	...
	return (
		<div
			className="flex w-full  items-center justify-start pb-2 overflow-hidden  shadow-md rounded-xl shadow-slate-400 h-[170px] px-2 gap-x-4 md:w-[400px] ">
			{loading && (
				<div>
			...
			<div className="flex flex-col items-start gap-2 p-2 bg-gree-  ">
				<div>
